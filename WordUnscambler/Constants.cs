namespace WordUnscambler
{
    class Constants
    {
        ...
        public const string EnterScrambledWordsViaFile = "Enter full patch including the file name: ";
        public const string EnterScrambledWordsManually = "Enter word(s) manually (separetad by commas if multiple): ";
        public const string EnterScrambledWordsOptionNotRecognized = "The option was not recognized ";

        public const string ErrorScrambledWordsCannotBeLoaded = "Scrambled words were not loades because there was an error: ";
